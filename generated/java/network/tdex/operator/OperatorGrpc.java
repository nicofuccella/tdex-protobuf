...
public final class OperatorGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<network.tdex.operator.OperatorOuterClass.UpdateMarketFeeRequest,
      network.tdex.operator.OperatorOuterClass.UpdateMarketFeeReply> getUpdateMarketFeeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "UpdateMarketFee",
      requestType = network.tdex.operator.OperatorOuterClass.UpdateMarketFeeRequest.class,
      responseType = network.tdex.operator.OperatorOuterClass.UpdateMarketFeeReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<network.tdex.operator.OperatorOuterClass.UpdateMarketFeeRequest,
      network.tdex.operator.OperatorOuterClass.UpdateMarketFeeReply> getUpdateMarketFeeMethod() {
    io.grpc.MethodDescriptor<network.tdex.operator.OperatorOuterClass.UpdateMarketFeeRequest, network.tdex.operator.OperatorOuterClass.UpdateMarketFeeReply> getUpdateMarketFeeMethod;
    if ((getUpdateMarketFeeMethod = OperatorGrpc.getUpdateMarketFeeMethod) == null) {
      synchronized (OperatorGrpc.class) {
        if ((getUpdateMarketFeeMethod = OperatorGrpc.getUpdateMarketFeeMethod) == null) {
          OperatorGrpc.getUpdateMarketFeeMethod = getUpdateMarketFeeMethod =
              io.grpc.MethodDescriptor.<network.tdex.operator.OperatorOuterClass.UpdateMarketFeeRequest, network.tdex.operator.OperatorOuterClass.UpdateMarketFeeReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "UpdateMarketFee"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  network.tdex.operator.OperatorOuterClass.UpdateMarketFeeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  network.tdex.operator.OperatorOuterClass.UpdateMarketFeeReply.getDefaultInstance()))
              .setSchemaDescriptor(new OperatorMethodDescriptorSupplier("UpdateMarketFee"))
              .build();
        }
      }
    }
    return getUpdateMarketFeeMethod;
  }
  ...
  public static abstract class OperatorImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void updateMarketFee(network.tdex.operator.OperatorOuterClass.UpdateMarketFeeRequest request,
        io.grpc.stub.StreamObserver<network.tdex.operator.OperatorOuterClass.UpdateMarketFeeReply> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getUpdateMarketFeeMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getUpdateMarketFeeMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                network.tdex.operator.OperatorOuterClass.UpdateMarketFeeRequest,
                network.tdex.operator.OperatorOuterClass.UpdateMarketFeeReply>(
                  this, METHODID_UPDATE_MARKET_FEE)))
          .addMethod(
  ...
  public static final class OperatorStub extends io.grpc.stub.AbstractAsyncStub<OperatorStub> {
    ...
    public void updateMarketFee(network.tdex.operator.OperatorOuterClass.UpdateMarketFeeRequest request,
        io.grpc.stub.StreamObserver<network.tdex.operator.OperatorOuterClass.UpdateMarketFeeReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getUpdateMarketFeeMethod(), getCallOptions()), request, responseObserver);
    }
  ...
  public static final class OperatorBlockingStub extends io.grpc.stub.AbstractBlockingStub<OperatorBlockingStub> {
     ...
     * </pre>
     */
    public network.tdex.operator.OperatorOuterClass.UpdateMarketFeeReply updateMarketFee(network.tdex.operator.OperatorOuterClass.UpdateMarketFeeRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getUpdateMarketFeeMethod(), getCallOptions(), request);
    }
  ...
  public static final class OperatorFutureStub extends io.grpc.stub.AbstractFutureStub<OperatorFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<network.tdex.operator.OperatorOuterClass.UpdateMarketFeeReply> updateMarketFee(
        network.tdex.operator.OperatorOuterClass.UpdateMarketFeeRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getUpdateMarketFeeMethod(), getCallOptions()), request);
    }
  ...
  private static final int METHODID_UPDATE_MARKET_FEE = 9;
  private static final int METHODID_UPDATE_MARKET_PRICE = 10;
  private static final int METHODID_UPDATE_MARKET_STRATEGY = 11;
  private static final int METHODID_WITHDRAW_MARKET = 12;
  private static final int METHODID_LIST_TRADES = 13;
  private static final int METHODID_REPORT_MARKET_FEE = 14;
  private static final int METHODID_RELOAD_UTXOS = 15;
  private static final int METHODID_LIST_UTXOS = 16;
  private static final int METHODID_DROP_MARKET = 17;
      ...
      switch (methodId) {
        ...
        case METHODID_LIST_MARKET:
          serviceImpl.listMarket((network.tdex.operator.OperatorOuterClass.ListMarketRequest) request,
              (io.grpc.stub.StreamObserver<network.tdex.operator.OperatorOuterClass.ListMarketReply>) responseObserver);
          break;
        case METHODID_UPDATE_MARKET_FEE:
          serviceImpl.updateMarketFee((network.tdex.operator.OperatorOuterClass.UpdateMarketFeeRequest) request,
              (io.grpc.stub.StreamObserver<network.tdex.operator.OperatorOuterClass.UpdateMarketFeeReply>) responseObserver);
          break;
      ...
      synchronized (OperatorGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getUpdateMarketFeeMethod())
